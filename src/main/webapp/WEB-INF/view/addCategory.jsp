			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6">
								<cf:form method="POST" action="addCategory" modelAttribute="category" role="form" >
									<cf:hidden path="id" />
									<div class="form-group">
										<cf:label path="name">Category Name</cf:label> 
										<cf:input path="name" class="form-control" placeholder="Enter text" /><br /> <cf:errors
